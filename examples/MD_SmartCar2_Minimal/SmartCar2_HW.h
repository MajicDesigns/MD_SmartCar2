...
// Right Motor
const uint8_t PIN_INB1 = 6;    // Motor B Mode pin 1 - simple digital pin
const uint8_t PIN_INB2 = 7;    // Motor B Mode pin 2 - simple digital pin
const uint8_t PIN_INB3 = 8;    // Motor B Mode pin 3 - simple digital pin
const uint8_t PIN_INB4 = 9;    // Motor B Mode pin 3 - simple digital pin
